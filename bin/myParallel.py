...
#read sample names based on sample_info.csv
    def read_sample_info(self):
        ...
        for line in in_obj:
            line = line.rstrip("\n")
            raw_file_name, sample_name, group = line.split(',')
            #
            if group == 'NC':
                NC_samples.append(sample_name)
            else:
                phip_samples.append(sample_name)
            sample_names.append(sample_name)
        in_obj.close()
        return sample_names, NC_samples, phip_samples
